<div class="logo"><a href="index.php" style="display:block;">
    ...
    <ul id="menu" class="nav">
        <li class="dash" id="menu1"><a class=" active" title="" href="index.php">
            ...
            <li class="categories_li <?php if(in_array($_GET['type'], array('chinh-sach','txtthu-vien','thu-vien','link-danh-muc',
            'y-kien','dich-vu','dich-vu-dac-biet','tin-tuc','txttin-tuc','tieu-chi','bang-gia','khuyen-mai')) 
            or $_GET['com']=='vnexpress') 
            echo ' activemenu' ?>" id="menu_tt"><a href="" title="" class="exp"><span>
            Bài viết</span><strong></strong></a>
            <ul class="sub">
                <?php phanquyen_menu('Hình danh mục','news','man','link-danh-muc'); ?>
        ...
        <li class="categories_li <?php if(in_array($type, array('tuyen-dung','gioi-thieu','lienhe','footer')))
  ...
  <ul class="sub">
    ...
    <?php phanquyen_menu('Giấy chứng nhận','slider','man_photo','quang-cao'); ?>
