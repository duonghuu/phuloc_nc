...
<div class="box_container">
   ...
   <div class="product_info">
    ...
    <?php if($row_detail['diachi'] != '') { ?><div class="li"><b>Địa chỉ:</b> 
...
<img src="https://chart.googleapis.com/chart?chs=200x200&cht=qr&choe=UTF-8&chl=<?= getCurrentPageURL() ?>" alt="<?= $row_detail["ten"] ?>">
<?php /* 
